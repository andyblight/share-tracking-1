...
class TransactionsTable:
    ...
    def add_test_rows(self):
        self.add_row(date(2022, 5, 22), "B", 4, 20, 1.23, 0.6, 25.20)
        self.add_row(date(2022, 6, 22), "S", 3, 30, 1.00, 3.50, 33.50)

    def add_row(self, date_obj, type, security_id, quantity, price, costs, total):
